...
##make label data frames that are just one state from each of the regions because I can't think of a better way to get them spatially specific right now
west_lab <- states %>% 
...
ggplot(states) +
  ...
  ##add each label and set its color and size/typeface specs, etc. 
...
Number of Homes Bar Plot

```{r}

##make bar plot of the total number of homes in each region and fill by the region color
